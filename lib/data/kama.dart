// lib/data/kama_data.dart
// Datos locales del Kamasutra — migrar a API en el futuro.
...
extension KamaLevelX on KamaLevel {
  ...
  // Porcentaje de relleno del indicador de dificultad (1–3 fuegos)
  int get fires {
    switch (this) {
      case KamaLevel.facil:
        return 1;
...
class KamaPosition {
  final String name;
  final String emoji;
  final String shortDesc; // 1 línea para la card
  final String fullDesc; // descripción explícita completa
  final String tips; // consejo para hacerlo bien
  final KamaLevel level;
  final String link; // URL de referencia visual / video
...
const List<KamaPosition> kKamaPositions = [
  ...
  KamaPosition(
    ...
    level: KamaLevel.facil,
    link: 'https://www.healthline.com/health/healthy-sex/lotus-position-sex',
  ),
  ...
  KamaPosition(
    ...
    level: KamaLevel.medio,
    link: 'https://www.healthline.com/health/healthy-sex/butterfly-position',
  ),
  ...
  KamaPosition(
    ...
    level: KamaLevel.medio,
    link:
        'https://www.cosmopolitan.com/sex-love/positions/a8888/sex-positions-for-couples/',
  ),
  ...
  KamaPosition(
    ...
    level: KamaLevel.medio,
    link:
        'https://www.healthline.com/health/healthy-sex/lap-dance-sex-position',
  ),
  ...
  KamaPosition(
    ...
    level: KamaLevel.avanzado,
    link:
        'https://www.healthline.com/health/healthy-sex/standing-sex-positions',
  ),
